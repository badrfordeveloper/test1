          ...
          <div class="row my-auto">
              ...
              <div class="main-award" id="award-box" style="margin: auto;">
                  ...
                  <div class="award">
                      <div class="award-icon"></div>
                      <div class="award-content">
                          <span class="date">Janvier 2019 - Mars 2020</span>
                          <h5 class="title">WEBEXIT : DEVELOPPEUR FULL STACK</h5>
                          <p class="description">
                             Mission : Création des applications et sites web (E-commerce, vitrines, catalogue …).
                          </p>
                      </div>
                  </div>
                  <div class="award">
